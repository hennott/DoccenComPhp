...
function VisualDoc ($FullIndex) {
	...
	// @c:2017-03-16:Die Liste der Dateien wird nun korrekt nach dem Dateinamen sortiert.;
	...
	// @c:2017-03-16:Die Dateiansicht kann nun nach Ordnern strukturiert werden.;
	...
	if(isset($DocSetFileS) && count($DocSetFileS) > 0) {
		// @c:2017-03-16:Die Dateiliste wird aus dem Menü heraus nun nach Ordnern sortiert angezeigt.;
